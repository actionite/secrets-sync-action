...
![Release](https://github.com/actionite/secrets-sync-action/workflows/Release/badge.svg)
[![codecov](https://codecov.io/gh/actionite/secrets-sync-action/branch/master/graph/badge.svg)](https://codecov.io/gh/actionite/secrets-sync-action)
![GitHub contributors](https://img.shields.io/github/contributors/actionite/secrets-sync-action?color=green)
...
```yaml
uses: actionite/secrets-sync-action@[insert version or commit]
  with:
    SECRETS: |
      ^FOO$
      ^GITHUB_.*
